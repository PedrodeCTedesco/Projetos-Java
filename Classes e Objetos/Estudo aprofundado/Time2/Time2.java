...
public class Time2
{
	 ...
	 * +setHour(int hour): void --> valida e configura a hora
	 * @param int hour
	 * 
	 * +setMinute(int minute): void --> valida e configura o minuto
	 * @param int minute
	 * 
	 * +setSecond(int second): void --> valida e configura o segundo
	 * @param int second
	 * */
