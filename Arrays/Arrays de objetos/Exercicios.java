/**Classe contém os exercícios sobre Arrays da disciplina de Laboratório I.
...
public class Exercicios 
{
	...
	/**Métodos.
	 * +exercicio1(int[]: arr): void -> recebe um array de inteiros e os imprime ao contrário.
	 * +exercicio3(int[]: arr):void -> retorna um novo array somente com os números pares do array passado por parâmetro.
	 * +exercicio4(String[]: arr, String x): int -> retorna o valor da posição de "x" no array e -1 caso o valor de "x" não exista.
	 * +exercicio5(bool[] bool): int[] -> retorna um array de inteiros onde 1 equivale a true e 0 a false;
	 * +exercicio6(int[]arr1, int[]arr2): int[]arr3 -> retorna um terceiro array de inteiros com os valores dos dois arrays passados por parâmetro;
	 * +exercicio7(int[] arr1, int[]arr2): int[]arr3 -> retorna um terceiro array cuja primeira parte temos números negativos e na segunda parte números positivos;
	 * +exercicio8(char[] char1): char[]-> retorna todos os elementos do array 
	 * +exercicio9(int[] arr): int media -> retorna a média dos elementos do array.
	 * +exercicio10(int[]arr): int media -> retorna a média dos elementos pares do array.
	 * +exercicio11(int[]arr, int x): int arr[x] -> retorna o valor do elemento no array de inteiros na posição x.
	 * +exercicio12(double[] d): boolean -> retorna 'true' se algum elemento for negativo e retorna 'false' se todos forem positivos.
	 * +exercicio13(int[]arr): int -> retorna um inteiro que representa o maior valor do array de números inteiros.
	 * +exercicio14(int[]arr): int -> retorna a posição de índice do maior valor do array.
	 * +exercicio15(int[]arr): int -> retorna o valor do menor elemento do array.
	 * +exercicio16(int[]arr): int -> retorna o valor da posição de índice do menor elemento do array.
	 * +exercicio17(int[]arr1, int[]arr2) : boolean -> retorna 'true' se os arrays forem iguais e 'false' se não forem.
	 * +exercicio18(char[]char1): string -> retorna um string com o array de caracteres recebido.
	 * +exercicio19(int[]arr): string -> recebe valores para compor o array de inteiros via teclado e retorna uma string com esses valores.
	 * */
